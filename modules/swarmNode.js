...
class SwarmNode extends EventEmitter {
    ...
    getKeyPath() {
        ...
        // Gets Swarm Key path
        const swarmKeyDir = path.join(Settings.userDataPath, 'icubeswarmjs');
    ...
    startUsingLocalNode() {
        ...
        const swarmBinDir = path.join(Settings.userDataPath, 'icubeswarmjs', 'bin');
        ...
        const config = {
            ...
            dataDir: path.join(Settings.userDataPath, 'icubeswarmjs'),
    ...
    init() {
        ...
        if (Settings.swarmURL === 'http://localhost:8200') {
